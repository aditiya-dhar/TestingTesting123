...
class UniqueCollectionTest {
    ...
    @Test
    fun addAnItem() {
        collection.addItem(Item("Item 1"))
        assert(collection.get(0).name == "Item 1") {"Item not added"}
    }
    ...
    fun addUniqueItem() {
        collection.addItem(Item("Item 1"))
        collection.addItem(Item("item 1"))
        collection.addItem(Item("Item 2"))
        assert(collection.size() == 2) {"Items added are not unique"}
    }
